...
export default function Hero() {
  return (
    <div className="flex h-auto flex-col bg-white w-full">
      <Navbar />
      <div className="container mx-auto py-8 md:py-6 mt-10">
        ...
        <div className="-mt-1 items-center text-center px-4">
          <button className="bg-green-600 text-white px-3 py-3 rounded-2xl text-lg font-semibold w-full max-w-[200px] mx-auto sahdow-none hover:shadow-lg shadow-[#a6a6a6] transition-all duration-300 cursor-pointer" >
            Start Learning
          </button>
        </div>
      </div>
