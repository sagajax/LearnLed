...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-white ">
      ...
      <div className="md:hidden bg-gray-900 w-[350px] px-4 py-6 overflow-x-hidden">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-justify text-gray-300 mt-3 max-w-full break-words">
      ...
      {/* Navigation Links - responsive row with wrap */}
      <div className="flex flex-wrap justify-between border-t border-b border-gray-800 py-3">
        {mobileNavLinks.map((link) => (
          <a
            key={link.name}
            href={link.href}
            className="text-gray-300 text-sm hover:text-white transition-colors border-b border-gray-600 py-1"
          >
            {link.name}
          </a>
        ))}
